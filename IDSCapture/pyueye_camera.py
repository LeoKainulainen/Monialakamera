...
try:
    ...
    from IDSCapture.pyueye_utils import (uEyeException, Rect, get_bits_per_pixel,
                                  ImageBuffer, check)
...
class Camera:
    ...
    def set_aoi(self, x, y, width, height, center_aoi):
        """
        width, height = 0 ; Camera sensor maximum width used
        """
        rect_aoi = ueye.IS_RECT()
        ...
        # if width == 0:
        #     print("Width set to Camera's sensor width", rect_aoi.s32Width)
        # else:
        #     rect_aoi.s32Width = ueye.int(width)
        # if height == 0:
        #     print("Height set to Camera's sensor height", rect_aoi.s32Height)
        # else:
    ...
    def set_auto_pixelclock_framerate(self,pixelclock,framerate):
        print("full auto")
        disable = ueye.DOUBLE(0)
        enable = ueye.DOUBLE(1)
        zero = ueye.DOUBLE(0)
